...
hold on;
h3 = plot([-20-2 20+2],[0+2 0+2],'b','Linewidth',3); hold on;
plot([20+2 20+2],[0+2 -12-2],'b','Linewidth',3); hold on;
plot([20+2 -20-2],[-12-2 -12-2],'b','Linewidth',3); hold on;
plot([-20-2 -20-2],[0+2 -12-2],'b','Linewidth',3);
