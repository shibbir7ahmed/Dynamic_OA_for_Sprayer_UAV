...
hold on;
h3 = plot([-20-1.1 20+1.1],[0+1.1 0+1.1],'b','Linewidth',3); hold on;
plot([20+1.1 20+1.1],[0+1.1 -12-1.1],'b','Linewidth',3); hold on;
plot([20+1.1 -20-1.1],[-12-1.1 -12-1.1],'b','Linewidth',3); hold on;
plot([-20-1.1 -20-1.1],[0+1.1 -12-1.1],'b','Linewidth',3);
