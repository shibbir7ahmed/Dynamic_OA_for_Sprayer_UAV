%% Load Data
% Load Obstacles data by clicking the Full Path/ Obstacles.mat
% Load simulation output data by clicking the LQ=XX.mat file
...
% MakeSure to change the SprayLength.
% 2 meter Mission: 1
% 3 meter Mission: 1.5
% 4 meter Mission: 2
SprayLength = 1;
...
area_resolution = 2;
for i = 51:2:length(out.time)
    Px = out.XYZ(i,1);
    Py = out.XYZ(i,2);
    p1 = [Px+SprayLength,Py-SprayLength];
    p2 = [Px-SprayLength,Py-SprayLength];
    p3 = [Px-SprayLength,Py+SprayLength];
    p4 = [Px+SprayLength,Py+SprayLength];
...
hold on;
h3 = plot([-20-SprayLength 20+SprayLength],[0+SprayLength 0+SprayLength],'b','Linewidth',3); hold on;
plot([20+SprayLength 20+SprayLength],[0+SprayLength -12-SprayLength],'b','Linewidth',3); hold on;
plot([20+SprayLength -20-SprayLength],[-12-SprayLength -12-SprayLength],'b','Linewidth',3); hold on;
plot([-20-SprayLength -20-SprayLength],[0+SprayLength -12-SprayLength],'b','Linewidth',3);
